...
- Color scheme: Light, evoking softness and dreaminess.
- Primary color: A gentle, medium blue (#388FE0), reminiscent of a clear sky, used for interactive elements and highlights.
- Background color: A very light, desaturated blue (#ECF2F7), providing a soft and airy canvas.
- Accent color: A vibrant greenish-blue (#1FA199), offering a complementary pop for playful elements and subtle glowing effects.
- Heading font: 'Playfair' (modern sans-serif), chosen for its elegant, high-contrast, and fashionable aesthetic to create an award-winning feel.
- Body font: 'PT Sans' (humanist sans-serif), selected for its clean, modern readability and subtle warmth, balancing the elegance of the headings.
- Use delicate floating hearts for backgrounds, charming icons for gift suggestions, and symbolic markers for the interactive map, maintaining a playful and romantic theme.
- Layout is fully responsive and mobile-first, ensuring a seamless experience across all devices, with dedicated masonry or grid patterns for photo galleries.
- Incorporate smooth, subtle animations throughout the site using GSAP or CSS animations, including animated background gradients/particles, line-by-line text reveals, hover effects, lightbox transitions, and dynamic confetti/fireworks for the grand surprise.